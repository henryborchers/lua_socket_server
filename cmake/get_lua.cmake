if (PYTHONINTERP_FOUND)
    ...
    add_custom_command(
            ...
            COMMAND ${PYTHON_EXECUTABLE} -m hererocks ${CMAKE_BINARY_DIR}/lua --lua 5.3 --patch --luarocks 2.4.3
    ...
    if (WIN32)
        ...
        set_target_properties(lua::luarocks PROPERTIES
                IMPORTED_LOCATION ${CMAKE_BINARY_DIR}/lua/bin/luarocks-5.3
                )
    endif ()
    ...
    add_dependencies(lua::lib LuaRocks_hererocks)
